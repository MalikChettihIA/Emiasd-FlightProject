 ...
 *
 */
abstract class BiDataPreprocessor {
   ...
   */
  def preprocess(rawData: DataFrame, flightData: DataFrame)(implicit spark: SparkSession, configuration: AppConfiguration = null): DataFrame
