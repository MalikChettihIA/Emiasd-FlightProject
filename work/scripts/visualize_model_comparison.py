...
# -*- coding: utf-8 -*-
"""
Visualization script for Comparing Multiple Models
...
Uses model names (e.g., md-rf, md-gbt) instead of dataset names for comparison.

Usage:
    python visualize_model_comparison.py <output_directory>
"""
...
def extract_short_name(exp_name):
    """
    Extrait le nom du modèle du nom d'expérience (ex: md-rf pour middle-random forest)
    Format attendu: Experience-<model_part1>-<model_part2>-local-D2-...
    """
    parts = exp_name.split('-')
    if len(parts) >= 3:
        # Extrait les parties 1 et 2 qui correspondent au nom du modèle
        # Ex: Experience-md-rf-local-D2-60-7-7 -> md-rf
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python visualize_model_comparison.py <output_directory>")
        sys.exit(1)
    ...
    print("="*80)
    print("Models Comparison Visualization")
    print("="*80)
